...
/// <summary>
/// Network related UI functions/manager
/// </summary>
namespace Network {
    public class NetworkingUI : MonoBehaviour {
        ...
        private NetworkManager m_states;
        ...
        private void Start() {
            m_states = FindObjectOfType<NetworkManager>();
        }
        ...
        public void SinglePlayer() {
            m_states.currentState = NetworkManager._NetworkState.Single;
        }

        public void MultiPlayer() {
            m_Selection.SetActive(false);
            m_RoomCanvas.SetActive(true);
            m_states.currentState = NetworkManager._NetworkState.Multi;
